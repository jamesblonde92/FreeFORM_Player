...
public class Tester {
    ...
    public static void main(String args[]){
        ...
        if (testSongObject()){
            System.out.print("Song object is storing data and functioning according to expectations.");
        }
        else{
            System.out.print("Song object is not functioning properly");
        }
    }
    ...
    public static boolean testSongObject(){
        ...
        //String mySongGenre = mySong.getGenre();
